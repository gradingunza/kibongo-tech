                ...
                <div className="mb-4 md:mb-6">
                  ...
                  <div className="space-y-1 md:space-y-2">
                    {phoneNumbers.map((phone, idx) => (
                      <div
                        key={idx}
                        className="flex items-center justify-between p-1.5 md:p-2 hover:bg-gray-50 rounded-lg transition-colors"
                      >
                ...
                <div className="mb-4 md:mb-6">
                  ...
                  <div className="space-y-1 md:space-y-2">
                    {emails.map((email, idx) => (
                      <div
                        key={idx}
                        className="flex flex-col sm:flex-row sm:items-center justify-between p-1.5 md:p-2 hover:bg-gray-50 rounded-lg transition-colors gap-1 sm:gap-0"
                      >
                        <span className="text-xs md:text-sm text-gray-600">
                          {email.label}
                        </span>
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-4 md:p-6 hover:shadow-lg transition-shadow">
                ...
                <div className="mt-3 md:mt-4 bg-gray-100 rounded-lg h-32 md:h-48 flex items-center justify-center">
                  <div className="text-center">
                    <MapPin
                      size={24}
                      className="text-green-600 mx-auto mb-1 md:mb-2"
                    />
                    <p className="text-xs text-gray-500">
              ...
              >
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      className="w-full pl-8 md:pl-10 pr-3 py-1.5 md:py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    required
                    className="w-full px-3 py-1.5 md:py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 bg-white"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={4}
                    className="w-full px-3 py-1.5 md:py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 resize-none"
